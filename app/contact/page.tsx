      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Get in touch with our team to learn how SomaticHealth can transform your practice
          </p>
        </div>
      </section>
              ...
              <CardContent>
                <form className="space-y-6">
                  ...
                  <div>
                    ...
                    <Textarea id="message" rows={4} placeholder="Tell us more about your needs..." />
                  </div>
                ...
                <CardContent className="p-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@somatichealth.com</p>
                      <p className="text-gray-600">support@somatichealth.com</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">Located in the heart of San Francisco</p>
          </div>
